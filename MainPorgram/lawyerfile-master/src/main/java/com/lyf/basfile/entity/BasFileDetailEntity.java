 ...
 */
@Entity
@Table(name = "bas_file_detail", schema = "")
@SuppressWarnings("serial")
public class BasFileDetailEntity implements java.io.Serializable {
	/**主键*/
	private java.lang.String id;
	/**模版文件ID*/
	@Excel(name="模版文件ID",width=15)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  模版文件ID
	 */

	@Column(name ="BAS_FILE_OID",nullable=true,length=36)
